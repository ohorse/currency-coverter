...
public class CurrencyCalculatorTest {
    ...
    public void setUp() {
        CurrencyRatesDownloader ratesDownloader = 
                mock(CurrencyRatesDownloader.class);
        
        when(ratesDownloader.downloadRate(Currency.PLN, Currency.USD))
        .thenReturn(new BigDecimal("4"));
        
        when(ratesDownloader.downloadRate(Currency.PLN, Currency.EUR))
    ...
    public void testCalculate1() throws Exception {
        ...
        BigDecimal result = 
                classUnderTest.calculate(amount, from, to);
